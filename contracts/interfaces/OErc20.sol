...
contract OErc20 is OToken, OErc20Storage {
    ...
    function sweepToken(IEIP20NonStandard token) external override {
        ...
        uint256 underlyingBalanceBefore = IEIP20(underlying).balanceOf(
            address(this)
        );
        ...
        require(
            underlyingBalanceBefore ==
                IEIP20(underlying).balanceOf(address(this)),
            "underlying balance changed"
        );
    }
        ...
        returns (uint256)
    {
        ...
        uint256 balanceBefore = IEIP20(underlying).balanceOf(address(this));
        ...
        uint256 balanceAfter = IEIP20(underlying).balanceOf(address(this));
